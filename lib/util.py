...
block_explorer_info = {
    'blocktree.io': ('http://www.blocktree.io',
                        {'tx': 'transaction/UNO', 'addr': 'address/UNO'}),
    'cryptap.us': ('http://insight-uno.cryptap.us',
                        {'tx': 'tx', 'addr': 'address'}),
}

def block_explorer(config):
    return config.get('block_explorer', 'blocktree.io')
