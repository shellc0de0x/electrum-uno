...
class ElectrumWindow(QMainWindow):
    ...
    def load_wallet(self, wallet):
        ...
        title = 'Unobtanium Electrum %s  -  %s' % (self.wallet.electrum_version, self.wallet.basename())
        ...
        if self.wallet.is_watching_only():
            msg = ' '.join([
                ...
                _("This means you will not be able to spend Unobtanium with it."),
                _("Make sure you own the seed phrase or the private keys, before you request Unobtanium to be sent to this wallet.")
            ])
    ...
    def backup_wallet(self):
        ...
        if new_path != path:
            try:
                ...
                QMessageBox.critical(None,"Unable to create backup", _("Unobtanium Electrum was unable to copy your wallet file to the specified location.")+"\n" + str(reason))
    ...
    def init_menubar(self):
        ...
        help_menu.addAction(_("&Official website"), lambda: webbrowser.open("https://cryptap.us/uno/electrum"))
    ...
    def show_report_bug(self):
        QMessageBox.information(self, "Unobtanium Electrum - " + _("Reporting Bugs"),
            _("Please report any bugs as issues on github:")+" <a href=\"https://github.com/cryptapus/electrum-uno/issues\">https://github.com/spesmilo/electrum/issues</a>")
    ...
    def create_receive_tab(self):
        ...
        msg = _('Unobtanium address where the payment should be received. Note that each payment request uses a different Bitcoin address.')
        ...
        msg = ' '.join([
            ...
            _('Expired requests have to be deleted manually from your list, in order to free the corresponding Unobtanium addresses'),
        ])
    ...
    def create_send_tab(self):
        ...
        msg = _('Recipient of the funds.') + '\n\n'\
              + _('You may enter an Unobtanium address, a label from your list of contacts (a list of completions will be proposed), or an alias (email-like address that forwards to an Unobtanium address)')
        ...
        msg = _('Unobtanium transactions are in general not free. A transaction fee is paid by the sender of the funds.') + '\n\n'\
    ...
    def read_send_tab(self):
        ...
        for _type, addr, amount in outputs:
            if addr is None:
                QMessageBox.warning(self, _('Error'), _('Unobtanium Address is None'), _('OK'))
                return
            if _type == 'address' and not bitcoin.is_address(addr):
                QMessageBox.warning(self, _('Error'), _('Invalid Unobtanium Address'), _('OK'))
                return
            if amount is None:
    ...
    def pay_to_URI(self, URI):
        ...
        try:
            ...
            QMessageBox.warning(self, _('Error'), _('Invalid unobtanium URI:') + '\n' + str(e), _('OK'))
            return
        self.tabs.setCurrentIndex(1)
    ...
    def new_account_dialog(self, password):
        ...
        e = QLineEdit()
        vbox.addWidget(e)
        msg = _("Note: Newly created accounts are 'pending' until they receive unobtanium.") + " " \
    ...
    def tx_from_text(self, txt):
        ...
        if is_hex:
            try:
                ...
                traceback.print_exc(file=sys.stdout)
                QMessageBox.critical(None, _("Unable to parse transaction"), _("Unobtanium Electrum was unable to parse your transaction"))
                return
    ...
    def read_tx_from_file(self):
        ...
        try:
            ...
            QMessageBox.critical(None, _("Unable to read file or no transaction found"), _("Unobtanium Electrum was unable to open your transaction file") + "\n" + str(reason))
    ...
    def export_privkeys_dialog(self, password):
        ...
        try:
            ...
            export_error_label = _("Unobtanium Electrum was unable to produce a private key-export.")
    ...
    def do_import_labels(self):
        ...
        try:
            ...
            QMessageBox.critical(None, _("Unable to import labels"), _("Unobtanium Electrum was unable to import your labels.")+"\n" + str(reason))
    ...
    def do_export_labels(self):
        ...
        try:
            ...
            QMessageBox.critical(None, _("Unable to export labels"), _("Unobtanium Electrum was unable to export your labels.")+"\n" + str(reason))
    ...
    def settings_dialog(self):
        ...
        def on_unit(x):
            ...
            if self.base_unit() == unit_result:
                return
            if unit_result == 'kg/Un':
                self.decimal_point = 8
            elif unit_result == 'gm/Un':
                self.decimal_point = 5
            elif unit_result == 'mg/Un':
        ...
        if self.need_restart:
            QMessageBox.warning(self, _('Success'), _('Please restart Unobtanium Electrum to activate the new GUI settings'), _('OK'))



    def run_network_dialog(self):
        if not self.network:
            QMessageBox.warning(self, _('Offline'), _('You are using Unobtanium Electrum in offline mode.\nRestart Electrum if you want to get connected.'), _('OK'))
            return
    ...
    def plugins_dialog(self):
        ...
        d.setWindowTitle(_('Unobtanium Electrum Plugins'))
        d.setModal(1)
